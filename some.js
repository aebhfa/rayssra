...
function UnityProgress(gameInstance, progress) {
    ...
    {
        gameInstance.textProgress.innerHTML = '100000000000000000000000000000000000000000% - Running, Wait..';
        //gameInstance.progress.style.display = 'none';
    }
    else
    {
        gameInstance.textProgress.innerHTML = 'NIGGER - ' + Math.floor(progress * 100) + '%';
    }
